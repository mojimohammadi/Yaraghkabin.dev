...
html:is(.ahura-dark-theme, .ahura-black-theme) .topbar,
html:is(.ahura-dark-theme, .ahura-black-theme) #topbar,
html:is(.ahura-dark-theme, .ahura-black-theme) #topbar .bottom-section,
...
html:is(.ahura-dark-theme, .ahura-black-theme) .commentlist .review, html:is(.ahura-dark-theme, .ahura-black-theme) .commentlist .comment, html:is(.ahura-dark-theme, .ahura-black-theme) input, html:is(.ahura-dark-theme, .ahura-black-theme) textarea{
  border-color:var(--ahura-c-border-secondary);
  background-color: transparent;
}
...
html:is(.ahura-dark-theme, .ahura-black-theme) .select2-container--default .select2-results__option,html:is(.ahura-dark-theme, .ahura-black-theme) .header-popup-login-form label,html:is(.ahura-dark-theme, .ahura-black-theme) .header-popup-login-form span{
  color: var(--ahura-c-text-secondary);
}
