	...
	protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .postbox4 article .fimage img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'default' => [
                    'is_linked' => true,
                    'top' => 20,
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .postbox4 article' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'default' => [
                    'is_linked' => true,
                    'top' => 20,
	...
	protected function render() {
        ...
        <div class="postbox4">
            ...
            <?php if($settings['archive_btn_show'] == 'yes'): ?>
                <a style="background-color:<?php echo $settings['button_color']; ?>;box-shadow:0 5px 20px <?php echo $settings['button_color']; ?>80" class="cat-more-link" href="<?php echo get_category_link( $first_cat_id ) ?>" target="<?php echo $settings['target_link']; ?>">
