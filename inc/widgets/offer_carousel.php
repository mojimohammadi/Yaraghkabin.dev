    ...
    public function render()
    {
        ...
        <div class="ahura-offer-carousel offer-carousel-<?php echo $wid ?>">
            ...
            <script type="text/javascript">
                var lines = document.querySelectorAll('.offer-carousel-<?php echo $wid ?> .slider-duration-line');
                let autoPlayDelay = <?php echo $duration; ?>;
                
                jQuery(document).ready(function($){
                    var offer_carousel_swiper = new Swiper('.offer-carousel-<?php echo $wid ?> .offer-carousel-1', {
                        init: true,
                        slidesPerView: 1,
                        spaceBetween: 5,
                        effect: "fade",
