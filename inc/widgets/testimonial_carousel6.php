    ...
    public function register_controls()
    {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__('Border', 'ahura'),
                'selector' => '{{WRAPPER}} .testimonial-carousel-6 .testimonial-carousel-item-content:hover',
            ]
        );
                ...
                <script type="text/javascript">
                    jQuery(document).ready(function($){
                        if (typeof window.Swiper != undefined) {
                            var tc6_swiper = new Swiper('.testimonial-carousel-6-<?php echo $wid; ?>', {
                                ...
                                <?php if($has_paginate): ?>
                                pagination: {
                                    el: ".testimonial-carousel-6-<?php echo $wid; ?> .tc-swiper-pagination",
                                    clickable: true,
                                ...
                                <?php if($has_navigate): ?>
                                navigation: {
                                    nextEl: ".testimonial-carousel-6-<?php echo $wid; ?> .tc-swiper-button-next",
                                    prevEl: ".testimonial-carousel-6-<?php echo $wid; ?> .tc-swiper-button-prev",
                                },
                                <?php endif; ?>
                                breakpoints: {
                                    640: {
