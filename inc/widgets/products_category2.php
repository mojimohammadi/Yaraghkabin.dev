        ...
        <script type="text/javascript">
            jQuery(document).ready(function($){
                if (typeof window.Swiper != undefined) {
                    var apc_swiper = new Swiper('.ahura-products-category2-carousel-<?php echo $wid; ?>', {
                        ...
                        <?php if($has_navigate): ?>
                        navigation: {
                            nextEl: ".ahura-products-category2-<?php echo $wid; ?> .apc-swiper-button-next",
                            prevEl: ".ahura-products-category2-<?php echo $wid; ?> .apc-swiper-button-prev",
                        },
                        <?php endif; ?>
                        breakpoints: {
                            640: {
