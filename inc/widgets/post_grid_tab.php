                            ...
                            foreach ($items as $item):
                                ...
                                <li class="elementor-repeater-item-<?php echo $item['_id'] . ' ' . $activeCls; ?>">
                                    <a href="#" class="pgt-item-btn" id="tab-item-<?php echo $item['_id'] ?>" data-wid="<?php echo $wid ?>" data-tab="#tab-content-<?php echo $item['_id'] ?>" data-settings="<?php echo base64_encode(json_encode($data)) ?>">
                                        <i class="<?php echo $item['item_icon']['value'] ?>"></i>
                                        ...
                                        if ($posts->have_posts()):
                                            ...
                                            while ($posts->have_posts()): $posts->the_post();
                                                ...
                                                <div class="col-12 col-sm-12 col-md-4 col-lg-3">
                                                    <div class="post-item" style="background-image: url(<?php echo (isset($img[0])) ? $img[0] : '' ?>); box-shadow: 0 0 15px var(--ahura-post-grid-1-<?php echo $selected_color ?>)">
                                                        <div class="overly" style="background-color: var(--ahura-post-grid-1-<?php echo $selected_color ?>)"></div>
                                                                ...
                                                                <?php if ($settings['item_meta_show'] === 'yes'): ?>
                                                                    <div class="post-metas">
                                                                        <div class="date">
                                                                            ...
                                                                            <span><?php echo (is_rtl()) ? ahura_jdate('j F', get_the_modified_time('G')) : $date ?></span>
                                                                        </div>
                                                                    </div>
                                                                <?php endif; ?>
