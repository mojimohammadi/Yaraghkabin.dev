                ...
                <?php if (!empty($settings['table_title'])): ?>
                    <div class="title">
                        <?php if ($settings['table_title_icon_show'] === 'yes'): ?>
                            <i class="icon <?= $settings['table_title_icon']['value'] ?? '' ?>"></i>
                        <?php endif; ?>
                ...
                <?php if (!empty($settings['table_price'])): ?>
                    <div class="price">
                        <?php if ($settings['table_price_special'] === 'yes'): ?>
                            <del class="discount">
                                <?= $settings['table_price_regular'] . ' ' . $settings['table_price_currency'] ?>
                            </del>
                        <?php endif; ?>
                        <div class="regular">
                            <div class="p"><?= $settings['table_price'] ?></div>
                            <div class="c"><?= $settings['table_price_currency'] ?></div>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
                            ...
                            <?php foreach ($items as $item): ?>
                                <li class="item elementor-repeater-item-<?= $item['_id'] ?>">
                                    <?php if (array_key_exists('value', $item['item_icon'])): ?>
                                        <i class="icon <?= $item['item_icon']['value'] ?>"></i>
                                    <?php endif; ?>
