    ...
    public function register_controls()
    {
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'box_shadow',
                'label' => __('Box shadow', 'ahura'),
                'selector' => '{{WRAPPER}} .testimonial-carousel-5 .testimonial-carousel-item-content',
                'fields_options' =>
                    [
                        'box_shadow_type' =>
                        [
                ...
                <script type="text/javascript">
                    jQuery(document).ready(function($){
                        if (typeof window.Swiper != undefined) {
                            var tc5_swiper = new Swiper('.testimonial-carousel-5-<?php echo $wid; ?>', {
                                ...
                                <?php if($has_paginate): ?>
                                pagination: {
                                    el: ".testimonial-carousel-5-<?php echo $wid; ?> .tc-swiper-pagination",
                                    clickable: true,
                                ...
                                <?php if($has_navigate): ?>
                                navigation: {
                                    nextEl: ".testimonial-carousel-5-<?php echo $wid; ?> .tc-swiper-button-next",
                                    prevEl: ".testimonial-carousel-5-<?php echo $wid; ?> .tc-swiper-button-prev",
                                },
                                <?php endif; ?>
                                breakpoints: {
                                    640: {
