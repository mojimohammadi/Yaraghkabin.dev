           ...
           <script type="text/javascript">
                jQuery(document).ready(function(){
                    if (typeof window.Swiper != undefined) {
                        var img_swiper_<?php echo $wid; ?> = new Swiper('.image-slider-1-<?php echo $wid; ?> .swiper', {
                            ...
                            <?php if($has_paginate): ?>
                            pagination: {
                                el: ".image-slider-1-<?php echo $wid; ?> .swiper-pagination",
                                clickable: true,
                            },
                            <?php endif; ?>
                            <?php if($has_navigate): ?>
                            navigation: {
                                nextEl: ".image-slider-1-<?php echo $wid; ?> .swiper-btn-next",
                                prevEl: ".image-slider-1-<?php echo $wid; ?> .swiper-btn-prev",
                            },
                            <?php endif; ?>
                            breakpoints: {
                                640: {
