        ...
        <script type="text/javascript">
            jQuery(document).ready(function($){
                if (typeof window.Swiper != undefined) {
                    var apc_swiper = new Swiper('.ahura-products-category-carousel-<?php echo $wid; ?>', {
                        ...
                        <?php if($has_paginate): ?>
                        pagination: {
                            el: ".ahura-products-category-<?php echo $wid; ?> .apc-swiper-pagination",
                            clickable: true,
                        ...
                        <?php if($has_navigate): ?>
                        navigation: {
                            nextEl: ".ahura-products-category-<?php echo $wid; ?> .apc-swiper-button-next",
                            prevEl: ".ahura-products-category-<?php echo $wid; ?> .apc-swiper-button-prev",
                        },
                        <?php endif; ?>
                        breakpoints: {
                            640: {
