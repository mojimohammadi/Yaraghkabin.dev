                ...
                <script type="text/javascript">
                    jQuery(document).ready(function($){
                        if (typeof window.Swiper != undefined) {
                            var tc3_swiper = new Swiper('.testimonial-carousel-3-<?php echo $wid; ?>', {
                                ...
                                <?php if($has_paginate): ?>
                                pagination: {
                                    el: ".testimonial-carousel-3-<?php echo $wid; ?> .tc-swiper-pagination",
                                    clickable: true,
                                ...
                                <?php if($has_navigate): ?>
                                navigation: {
                                    nextEl: ".testimonial-carousel-3-<?php echo $wid; ?> .tc-swiper-button-next",
                                    prevEl: ".testimonial-carousel-3-<?php echo $wid; ?> .tc-swiper-button-prev",
                                },
                                <?php endif; ?>
                                breakpoints: {
                                    640: {
