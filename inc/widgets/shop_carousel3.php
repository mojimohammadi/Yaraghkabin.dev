        ...
        <div class="shop-carousel3 ahura-items-carousel shop-carousel3-<?php echo $wid ?><?php echo $settings['show_box_title'] == 'yes' ? ' has-box-title' : '' ?>">
                                ...
                                <div class="row m-0 p-0 align-items-center">
                                    <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                                        <div class="carousel-cover">
                                            <?php echo wp_get_attachment_image(get_post_thumbnail_id(), 'full'); // $settings['item_cover_size'] ?>
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-12 col-md-8 col-lg-8">
                                        <div class="carousel-details">
                                            ...
                                            <div class="add-to-cart-wrap"><?php woocommerce_template_loop_add_to_cart(); ?></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <script type="text/javascript">
                jQuery(document).ready(function($){
                    let carouselContainer = $('.shop-carousel3-<?php echo $wid ?>'),
                        carouselItems = $('.shop-carousel3-<?php echo $wid ?> .carousel-items'),
                        firstItem = $(carouselItems.children()[0]),
                        lastItem = $(carouselItems.children()[carouselItems.children().length - 1]),
                        carouselActive;
                    if(carouselItems.find('.carousel-item').length > 1){
                        function auto_carousel_<?php echo $wid ?>(){
                        ...
                        let auto_carousel_var = setInterval(auto_carousel_<?php echo $wid ?>, <?php echo $duration ?>);
                        $('.shop-carousel3-<?php echo $wid ?>').hover(
                            () => {clearInterval(auto_carousel_var)},
                            () => {auto_carousel_var = setInterval(auto_carousel_<?php echo $wid ?>, <?php echo $duration ?>)}
                        );
                    }
                });
            </script>
