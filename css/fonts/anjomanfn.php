...
<?php if(!\ahura\app\mw_options::get_mod_is_active_light_fontface()): ?>
    ...
    url('../../fonts/fanum/woff2/Anjoman-FaNum-Light.woff2') format('woff2');
    font-display: swap;
    }
<?php endif; ?>
<?php if(!\ahura\app\mw_options::get_mod_is_active_medium_fontface()): ?>
    ...
    url('../../fonts/fanum/woff2/Anjoman-FaNum-Regular.woff2') format('woff2');
    font-display: swap;
    }
<?php endif; ?>
<?php if(!\ahura\app\mw_options::get_mod_is_active_bold_fontface()): ?>
    ...
    url('../../fonts/fanum/woff2/Anjoman-FaNum-Bold.woff2') format('woff2');
    font-display: swap;
    }
<?php endif; ?>
