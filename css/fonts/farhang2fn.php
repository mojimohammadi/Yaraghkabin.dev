...
<?php if(!\ahura\app\mw_options::get_mod_is_active_bold_fontface()): ?>
    ...
    url('../../fonts/fanum/woff2/Farhang2FaNum-ExtraBold.woff2') format('woff2');
    font-display: swap;
    }
    @font-face {
    font-family: farhang2fn;
    ...
    url('../../fonts/fanum/woff2/Farhang2FaNum-Bold.woff2') format('woff2');
    font-display: swap;
    }
<?php endif; ?>
<?php if(!\ahura\app\mw_options::get_mod_is_active_light_fontface()): ?>
    ...
    url('../../fonts/fanum/woff2/Farhang2FaNum-Thin.woff2') format('woff2');
    font-display: swap;
    }
    @font-face {
    font-family: farhang2fn;
    ...
    url('../../fonts/fanum/woff2/Farhang2FaNum-Light.woff2') format('woff2');
    font-display: swap;
    }
<?php endif; ?>
<?php if(!\ahura\app\mw_options::get_mod_is_active_medium_fontface()): ?>
    ...
    url('../../fonts/fanum/woff2/Farhang2FaNum-Regular.woff2') format('woff2');
    font-display: swap;
    }
    @font-face {
    font-family: farhang2fn;
    ...
    url('../../fonts/fanum/woff2/Farhang2FaNum-Medium.woff2') format('woff2');
    font-display: swap;
    }
<?php endif; ?>
<?php if(!\ahura\app\mw_options::get_mod_is_active_black_fontface()): ?>
    ...
    url('../../fonts/fanum/woff2/Farhang2FaNum-Black.woff2') format('woff2');
    font-display: swap;
    }
<?php endif; ?>