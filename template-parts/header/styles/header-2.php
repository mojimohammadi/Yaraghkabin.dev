...
<div class="header-buttons">
    <div class="icon-buttons">
        <?php
        $custom_login_url = get_theme_mod('ahura_header_popup_login_link_to_url');
        ...
        if (\ahura\app\mw_options::get_mod_is_show_header_popup_login()): ?>
            <div class="h-login-wrap d-inline-block pos-relative">
                <a href="<?php echo $custom_login_url ? $custom_login_url : (is_user_logged_in() ? $login_url : '#ah-login-modal') ?>" class="h-btn h-user-login-btn <?php echo $with_name_cls ?>" rel="<?php echo !is_user_logged_in() ? 'modal:open' : '' ?>">
    ...
    <?php if(get_theme_mod('show_ahura_header_cta_btn',true)):?>
...
<div class="header-mobile-side">
    ...
    <div class="header-menu-side">
        <div class="close-menu"><i class="fad fa-times"></i></div>
