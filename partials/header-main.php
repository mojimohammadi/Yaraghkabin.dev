        ...
        <div class="topbar-main middle-section">
            <div class="row">
                ...
                <div class="col-md-<?php echo $is_menu_in_middle ? '3' : '4';?> action-box <?php echo \ahura\app\mw_options::get_mod_action_btn_alignment();?>">
                    <?php if(get_theme_mod('ahura_remove_header_search_box') != true):?><div class="search-btn-wrapper"><a href="#" id="action_search"><span class="fa fa-search"></span></a></div><?php endif;?>
                    ...
                    <?php endif;?> 
                    <?php if(get_theme_mod('show_ahura_header_cta_btn',true)):?><a href="<?php echo \ahura\app\mw_options::get_mod_header_cta_btn_url();?>" id="action_link"><?php echo \ahura\app\mw_options::get_mod_header_cta_btn_text();?></a><?php endif;?>
                </div>
            </div>
        </div>
