...
class Merlin {
	...
	protected function content() {
		...
		<div class="merlin__content--transition">
            ...
            if ( 1 < count( $this->import_files ) ) :
				...
				<div class="merlin__select-control-wrapper">
					...
					<select class="merlin__select-control js-merlin-demo-import-select" style="display: none">
						<?php foreach ( $this->import_files as $index => $import_file ) : ?>
							<option value="<?php echo esc_attr( $index ); ?>"><?php echo esc_html( $import_file['import_file_name'] ); ?></option>
						<?php endforeach; ?>
					</select>

                    <div class="merlin-demo-selector">
                        <div class="selected-demo">
                            <i class="demo-icon" style="background-image: url(<?php echo $demos[0]['import_demo_img'] ?>)"></i>
                            <span class="demo-title"><?php echo $demos[0]['import_file_name'] ?></span>
                        </div>
                    </div>
        ...
        <?php if($demos): ?>
        <div class="merlin-demo-lists-wrap">
            <span class="merlin-demo-lists-close"><?php _e('Close', 'ahura') ?></span>
            <div class="merlin-demo-lists">
                <div class="search-wrap">
                    <input type="text" placeholder="<?php _e('Search...', 'ahura') ?>">
                </div>
                <ul>
                    <?php foreach ($demos as $key => $demo): ?>
                        <li class="demo-item <?php echo $key == 0 ? 'selected ' : '' ?> <?php echo $demo['import_demo_cat'] ?>">
                            <a href="#" data-id="<?php echo $key ?>">
                                <img src="<?php echo $demo['import_demo_img'] ?>" alt="<?php echo esc_attr($demo['import_file_name']) ?>">
                                <span><?php echo $demo['import_file_name'] ?></span>
                            </a>
                        </li>
                    <?php endforeach; ?>
                </ul>
